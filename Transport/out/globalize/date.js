...
(function (root, factory) {
    ...
    function expandBestMatchFormat(skeletonWithoutFractionalSeconds, bestMatchFormat) {
        var i, j, bestMatchFormatParts, matchedType, matchedLength, requestedType, requestedLength, requestedSkeletonParts, 
    ...
    var dateExpandPatternGetBestMatchPattern = function (cldr, askedSkeleton) {
        var availableFormats, decimalSeparator, pattern, ratedFormats, skeleton, path = "dates/calendars/gregorian/dateTimeFormats/availableFormats", 
        // Using easier to read variables.
        augmentFormat = dateExpandPatternAugmentFormat, compareFormats = dateExpandPatternCompareFormats;
    ...
    var dateExpandPattern = function (options, cldr) {
        ...
        function combineDateTime(type, datePattern, timePattern) {
            return formatMessage(cldr.main([
            ...
            switch (chr) {
                ...
                case "V":
                    ...
                    if (timeZone) {
                        ...
                        var timeZoneName, exemplarCity = cldr.main([
            ...
            switch (chr) {
                ...
                case "O":
                    ...
                    properties["timeZoneNames/hourFormat"] = (length < 4 ?
                        ...
                        [dateTimezoneHourFormatHm(aux, "HH")]).map(function (hourFormat) {
    ...
    function validateOptionsPresetEach(type, options) {
        ...
        validate("E_INVALID_OPTIONS", "Invalid `{{type}: \"{value}\"}`.", value === undefined || ["short", "medium", "long", "full"].indexOf(value) !== -1, { type: type, value: value });
    }
    function validateOptionsSkeleton(pattern, skeleton) {
        validate("E_INVALID_OPTIONS", "Invalid `{skeleton: \"{value}\"}` based on provided CLDR.", skeleton === undefined || (typeof pattern === "string" && pattern), { type: "skeleton", value: skeleton });
    }
